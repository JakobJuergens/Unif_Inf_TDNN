\section{Variance Estimation Results}\label{sec:pw_inf}
\hrule
...
\subsection{Variance Estimation for the DNN-DML2 CATE Estimator}\label{CATE_Var_Ests}
\hrule
...
\begin{boxD}
	\begin{thm}[Consistent Variance Estimation for the DNN-DML2 CATE Estimator]\label{thm:CATE_DNN_DML_Var_Est}\mbox{}\\*
		{\color{red} LOREM IPSUM}
	\end{thm}
\end{boxD}
