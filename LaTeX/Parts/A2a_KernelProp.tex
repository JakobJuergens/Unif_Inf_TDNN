...
\begin{proof}[Proof of Lemma \ref{lem:kernel_prod_dirac_convergence}]\mbox{}\\*
    ...
    \begin{equation}
        \begin{aligned}
            ...
            \right]\\
            %
            & \quad \leq \frac{\left\{1-\varphi\left(B\left(x,\delta\right)\right)\right\}^{2s-c-2}}{\E_{D, D^{\prime}}\left[\kappa\left(x; Z_{1}, D\right)\kappa\left(x; Z_{c+1}^{\prime}, D^{\prime}\right)\right]}
            \cdot \E_{1, (c+1)^{\prime}}\left[\left| f(X_{1}) f(X_{c+1}^{\prime}) - f^{2}(x)\right|
            \left(1 - \1\left(X_1, X_{c+1}^{\prime} \in B(x, \delta)\right)\right)
            \right]\\
            %
            & \quad \leq \frac{\left\{1-\varphi\left(B\left(x,\delta\right)\right)\right\}^{2s-c-2}}{\E_{D, D^{\prime}}\left[\kappa\left(x; Z_{1}, D\right)\kappa\left(x; Z_{c+1}^{\prime}, D^{\prime}\right)\right]}
            ...
            %
            & \quad \leq \frac{\left\{1-\varphi\left(B\left(x,\delta\right)\right)\right\}^{2s-c-2}}{\E_{D, D^{\prime}}\left[\kappa\left(x; Z_{1}, D\right)\kappa\left(x; Z_{c+1}^{\prime}, D^{\prime}\right)\right]}
            \cdot \left(\|f\|_{L^1}^{2} + f^2(x)\right) 
            \longrightarrow 0 \quad \text{as} \quad s \rightarrow \infty
        \end{aligned}
    \end{equation}
