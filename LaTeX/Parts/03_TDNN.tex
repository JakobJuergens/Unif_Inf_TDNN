...
As a special example that illustrates the relationship, consider the DNN estimator choosing $s = n$. 
Clearly, this estimator recovers the simple 1-NN regression estimator.
...
\begin{boxD}
	\begin{thm}[Asymptotic Normality given Nuisance Parameters]\label{thm:CATE_ANorm_noFirstStage}\mbox{}\\*
