...
\hrule
While less economically attractive, we will introduce the TDNN estimator using the simple nonparametric regression setup first.
...
\begin{equation}
	...
	\end{aligned}
\end{equation}
Thus, given first-stage estimates of nuisance parameters, we have a closed-form representation of the CATE estimator for a given partition of $[n]$.
