	...
	\begin{dfn}{Honest Double-Cross-Fitting Forest}\mbox{}\\*
		...
		\begin{enumerate}
            ...
            \begin{equation}
                ...
                \end{cases}
            \end{equation}
            For each $k \in [K]$, use a first-stage estimator for the functional nuisance parameters on the data set $\mathbf{D}_{\mathcal{J}_{k}}$ to estimate the nuisance parameter $\eta_{0}$.
