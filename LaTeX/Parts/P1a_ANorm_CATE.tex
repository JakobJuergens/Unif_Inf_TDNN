...
\begin{proof}[Proof of Lemma \ref{lem:ps_hajek_error}]\mbox{}\\*
    ...
    \begin{equation}
        \begin{aligned}
            ...
            & \leq \sup_{\eta \in \mathcal{T}_{n}} 
             ...
             \overset{\text{Lem \ref{lem:rate_cond_errors1}}}{=} \left(s r_{n}^{\prime}\right)^{2}
        \end{aligned}
    \end{equation}
    By \citet{chernozhukov_doubledebiased_2018} Lemma 6.1, this allows us to draw the following conclusion.
    \begin{equation}
        \begin{aligned}
            \mathcal{I}_{3,k}^{(1)} = O_{p}\left(s r_{n}^{\prime}\right)
        \end{aligned}
    \end{equation}  
    ...
    \begin{equation}
        \begin{aligned}
            \bar{R}_{1, k}\left(x\right)
            & = O_{p}\left(\sqrt{\frac{1}{n}} \cdot s r_{n}^{\prime} + {\color{red} LOREM IPSUM}\right)
        \end{aligned}
    \end{equation}
