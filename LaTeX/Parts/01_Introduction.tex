...
Section \ref{sec:U_stat} further embeds the DNN estimators and their CATE derivatives into the context of U-statistics and introduces essential notation for the analysis of the estimators.
