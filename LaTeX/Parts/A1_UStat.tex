...
\end{equation}
As before, we define the higher-order projection terms, i.e. for $c = 2, \dotsc, s$, in the following way.
\begin{equation}
...
Plugging into the full expression for the CATE estimator, we obtain the following.
