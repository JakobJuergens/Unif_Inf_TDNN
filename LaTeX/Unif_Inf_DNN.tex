...
\begin{proof}
	...
	\begin{equation}
		\begin{aligned}
			...
			%
			& = \frac{n-1}{n} \sum_{i = 1}^{n}\left(
				\sum_{j = 1}^{s_2}\binom{s_2}{j}\left(H_{s_1, s_2}^{j}\left(\mathbf{x}; \mathbf{D}_{n}\right)\right)
				- H_{s_1, s_2}^{j}\left(\mathbf{x}; \mathbf{D}_{n, -i}\right)
			\right)^2\\
			%
			...
			& = \frac{n-1}{n} \sum_{i = 1}^{n}\left[
				\frac{s_2}{n} h^{(1)}_{s_1, s_2}(\mathbf{x}; \mathbf{Z}_i)
				+ \sum_{j \neq i} \left(\frac{s_2}{n} - \frac{s_2}{n-1}\right) h^{(1)}_{s_1, s_2}(\mathbf{x}; \mathbf{Z}_j) \right.\\
			& \quad \quad + \left.\sum_{j = 2}^{s_2}\binom{s_2}{j}\left(
