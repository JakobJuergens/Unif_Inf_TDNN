...
\begin{lem}\label{lem_omega_sc}\mbox{}\\*
	...
	\begin{equation}
		\Omega_{s}^{c}
		\lesssim 4 \mu^2\left(\mathbf{x}\right) + \sigma^2_{\varepsilon} + o(1)
		\quad \text{as} \quad s \rightarrow \infty.
	\end{equation}
\end{lem}
...
\begin{proof}[Proof of Lemma \ref{lem_omega_sc}]
	...
	\begin{equation}
		\begin{aligned}
			...
			\E_{D'}\left[|\mu(\mathbf{X}_{c+1}^{\prime})|\, (s-c) \, \kappa\left(\mathbf{x}; \mathbf{Z}_{c+1}^{\prime}, D^{\prime}\right)\right]                                                                                      \\
			%
			 & \quad \leq \left(\E_{D}\left[|\mu(\mathbf{X}_{c+1})|\, s \, \kappa\left(\mathbf{x}; \mathbf{Z}_{c+1}, D\right)\right]\right)^2
			\lesssim \mu^2(\mathbf{x}) + o(1)
		\end{aligned}
	\end{equation}
...
\begin{lem}\label{lem_upsilon_s}\mbox{}\\*
	...
	\begin{equation}
		\Upsilon_{s_1, s_2}
		\lesssim 2 \mu^{2}\left(\mathbf{x}\right) + \sigma^2_{\varepsilon} + o(1) 
	...
	\begin{equation}
		\begin{aligned}
			...
			%
			 ...
			 %
			 & \leq \E_{D}\left[\left(\mu^2(\mathbf{X}_1) + \sigma^2_{\varepsilon}\right) \, s_2 \, \kappa(\mathbf{x}; \mathbf{Z}_1, D)\right]
			 + \E_{D}\left[|\mu(\mathbf{X}_1)| \, s_1 \, \kappa(\mathbf{x}; \mathbf{Z}_1, D_{[s_1]})\right]
