...
\begin{proof}
	...
	\begin{equation}
		\begin{aligned}
			...
			+ 2 \sum_{j = 2}^{s_2} \frac{j}{s_2}\frac{n}{s_2}\left(\frac{s_2}{j}\frac{j}{e n}\right)^{j}
			\left[\binom{s_2}{j}V_{s_1, s_2}^{j}\right]
			= \frac{1}{n-1} V_{s_1, s_2}^{1}\left(\mathbf{x}\right)
			+ 8 \sum_{j = 2}^{s_2} \frac{j}{s_2} e^{-j}\left(\frac{s_2}{n}\right)^{j-1}
			\left[\binom{s_2}{j}V_{s_1, s_2}^{j}\right]                   \\
			%
			 & \leq \frac{1}{n-1} V_{s_1, s_2}^{1}\left(\mathbf{x}\right)
			+ \frac{8}{n}\sum_{j = 2}^{s_2}\left[\binom{s_2}{j}V_{s_1, s_2}^{j}\right]
			+ \frac{8}{n}\sum_{j = 2}^{s_2} (j-1)e^{-j}\left(\frac{s_2}{n}\right)^{j-1}
			\left[\binom{s_2}{j}V_{s_1, s_2}^{j}\right]\\
			%
			& = \frac{1}{n-1} V_{s_1, s_2}^{1}\left(\mathbf{x}\right)
			+ \frac{8}{n}\left(\zeta_{s_1, s_2}^{s_2} - s_2 \zeta_{s_1, s_2}^{1}\right)
			+ \frac{8}{n}\sum_{j = 2}^{s_2} (j-1)e^{-j}\left(\frac{s_2}{n}\right)^{j-1}
			\left[\binom{s_2}{j}V_{s_1, s_2}^{j}\right]\\
			%
			& \leq \frac{1}{n-1} V_{s_1, s_2}^{1}\left(\mathbf{x}\right)
			+ \frac{8}{n}\left(\zeta_{s_1, s_2}^{s_2} - s_2 \zeta_{s_1, s_2}^{1}\right)
			+ \frac{8}{n}\sum_{j = 2}^{\infty} (j-1)e^{-j}\left(\frac{s_2}{n}\right)^{j-1}V_{s_1, s_2}^{s_2}
			% & = \frac{1}{n-1} V_{s_1, s_2}^{1}\left(\mathbf{x}\right)
			% + \frac{8}{n}\left(\zeta_{s_1, s_2}^{s_2} - s_2 \zeta_{s_1, s_2}^{1}\right)
			% + \frac{8}{n}\sum_{j = 2}^{s_2} (j-2) \left[\binom{s_2}{j}V_{s_1, s_2}^{j}\right]
			% \leq \frac{1}{n-1} V_{s_1, s_2}^{1}\left(\mathbf{x}\right)
