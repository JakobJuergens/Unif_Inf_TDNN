...
This connection will prove useful going forwards.
...
\begin{equation}
	...
	= \operatorname{Cov}\left(h_{s}\left(\mathbf{x}; \mathbf{Z}_1, \ldots, \mathbf{Z}_c, \mathbf{Z}_{c+1}, \ldots, \mathbf{Z}_s\right),
...
$\xi_{s,s}\left(\mathbf{x}\right) = \operatorname{Var}\left(h_s\left(\mathbf{x}; \mathbf{Z}_1, \ldots, \mathbf{Z}_s\right)\right).$
...
\begin{equation}
	...
	= \operatorname{Cov}\left(h_{s_1, s_2}\left(\mathbf{x}; \mathbf{Z}_1, \ldots, \mathbf{Z}_c, \mathbf{Z}_{c+1}, \ldots, \mathbf{Z}_{s_2}\right),
