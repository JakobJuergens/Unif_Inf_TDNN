...
{\color{red}
	\begin{thm}[Jackknife Variance Estimator Consistency]\label{JK_Cons}
		LOREM IPSUM
	\end{thm}

	\begin{thm}[Bootstrap Variance Estimator Consistency]\label{BS_Cons}
		LOREM IPSUM
	\end{thm}
}
...
\appendix
\section{Proofs for Results in Section \ref{Subsampling_Improvements}}
\hrule
