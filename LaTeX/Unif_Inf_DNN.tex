...
\begin{abstract}
	...
	In this paper, I develop uniform inference procedures based on recent work by \citet{ritzwoller_uniform_2024} for the TDNN estimator.
	\dots
\end{abstract}
\vspace{0.3cm}
\hrule
...
Thus, we will instead consider the following assumption.
