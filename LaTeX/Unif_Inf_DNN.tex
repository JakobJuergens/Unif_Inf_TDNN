...
\onehalfspacing
\begin{abstract}
    I present a computationally simple method for estimating heterogeneous treatment effects based on a weighted nearest-neighbor-type estimator.
    ...
    This effectively results in a localized DDML variant that is new to the literature.
...
\newpage
\input{LaTeX/Parts/A2b_KernelAsymp.tex}
