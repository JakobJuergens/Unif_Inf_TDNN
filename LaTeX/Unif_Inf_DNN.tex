...
Furthermore, through an equivalent representation as an L-statistic developed by \citet{steele_exact_2009}, the estimator has a computationally simple way to be evaluated compared to the usual U-statistic approach.
...
\section{Subsampling Rate Improvements for the TDNN Estimator}
\hrule
...
Their results on the asymptotics of generalized U-statistics apply to a far broader class of estimators than nearest neighbors.
Specifically, their results on the asymptotics of generalized U-statistics and specific steps in their proofs will allow us to justify the necessary assumptions with small modifications.
