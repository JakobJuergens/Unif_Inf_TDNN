...
\onehalfspacing
\begin{abstract}
    This paper presents a computationally simple method for estimating heterogeneous treatment effects based on the two-scale distributional nearest neighbor estimator (TDNN) of \citet{demirkaya_optimal_2024}.
    ...
    Then we show how to apply these to perform uniformly valid inference in both the nonparametric regression setup and the heterogeneous treatment effect setup.
