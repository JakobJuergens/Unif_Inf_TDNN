...
\onehalfspacing
\begin{abstract}
    This paper presents a computationally simple method for estimating heterogeneous treatment effects based on a weighted nearest-neighbor-type estimator.
    ...
    This effectively results in a weighted-nearest-nearest-based DDML variant a that is new to the literature and resembles recent Kernel-based approaches under a data-adaptive kernel.
