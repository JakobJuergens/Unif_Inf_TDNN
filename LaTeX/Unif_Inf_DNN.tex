...
% \begin{lem}[\citet{demirkaya_optimal_2024} - Lemma 7]\label{lem:dem7}\mbox{}\\*
...
\begin{equation}\label{eq:psi_c_s}
...
\begin{proof}[Proof of Lemma \ref{lem:Cov_TDNN_k}]
	...
	To construct a lower bound we again follow a similar strategy as the proof in \citet{demirkaya_optimal_2024}.
	First, recall
	\begin{equation}
		\begin{aligned}
			{\color{red} LOREM IPSUM}
