...
\begin{equation}
	\begin{aligned}
		\Upsilon_{s_1, s_2}
		 & = \Cov\left(h_{s_1}\left(\mathbf{x}; \mathbf{Z}_1, \ldots,  \mathbf{Z}_{s_1}\right),
		h_{s_2}\left(\mathbf{x}; \mathbf{Z}_1, \ldots,\mathbf{Z}_{s_1}, \ldots, \mathbf{Z}_{s_2}\right)\right) \\
		 ...
		 h_{s_2}\left(\mathbf{x}; \mathbf{Z}_1, \ldots,\mathbf{Z}_{s_1}, \ldots, \mathbf{Z}_{s_2}\right) \, \Big| \, \sum_{i = 1}^{s_1} \1\left(\rk\right) \right)\right]
		 + \Cov
	\end{aligned}
\end{equation}
...
\begin{equation}
	\begin{aligned}
		\Upsilon_{s_1, s_2}^{c}
		 & = \Cov\left(h_{s_1}\left(\mathbf{x}; \mathbf{Z}_1, \ldots, \mathbf{Z}_c, \mathbf{Z}^{\prime}_{c+1}, \ldots,  \mathbf{Z}^{\prime}_{s_1}\right),
...
\begin{equation}
	\begin{aligned}
		...
		= \Var\left(h_{s_1, s_2}\left(\mathbf{x}; D\right)\right)                                                                                 \\
		%
		 & = \Var\left(
		w_{1}^{*}\left[\binom{s_2}{s_1}^{-1}\sum_{\ell \in L_{s_2, s_1}} h_{s_1}\left(\mathbf{x}; D_{\ell}\right)\right] + w_{2}^{*} h_{s_2}\left(\mathbf{x}; D\right)
		\right)                                                                                                                                                 \\
		%
		 & = \left(w_{1}^{*}\binom{s_2}{s_1}^{-1}\right)^2 \Var\left(\sum_{\ell \in L_{s_2, s_1}} h_{s_1}\left(\mathbf{x}; D_{\ell}\right)\right) \\
		 & \quad + 2 w_{1}^{*}w_{2}^{*}\binom{s_2}{s_1}^{-1} \Cov\left(
		\sum_{\ell \in L_{s_2, s_1}} h_{s_1}\left(\mathbf{x}; D_{\ell}\right), h_{s_2}\left(\mathbf{x}; D\right)
		\right)
		+ \left(w_{2}^{*}\right)^2 \xi_{s_2,s_2}                                                                                                                \\
		% 
		 & =
	\end{aligned}
\end{equation}
...
Recall that Lemma \ref{Cov_DNN_k} gives us the following result on the kernel of the DNN estimator.
\begin{equation}
	\lim_{n \rightarrow \infty} n^{-1}\frac{\xi_{s,s}\left(\mathbf{x}\right)}{\xi_{1,s}\left(\mathbf{x}\right)}
	= 0.
\end{equation}
Due to the explicit formula for the TDNN kernel shown in Lemma \ref{TDNN_kernel}, we can use this
