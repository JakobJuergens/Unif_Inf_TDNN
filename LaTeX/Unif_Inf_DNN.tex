...
At a later point, $\zeta_{s,s}$ and $\zeta_{1,s}$ will be of particular importance for our asymptotic analysis.
Thus, the following Lemma establishes explicit formulas for these terms.
