...
\onehalfspacing
\begin{abstract}
    This paper presents a novel method for estimating heterogeneous treatment effects nonparametrically based on a weighted nearest-neighbor estimator.
...
\newpage
\input{LaTeX/Parts/A2_UStat_Results.tex}
...
\newpage
\input{LaTeX/Parts/P1a_ANorm_NPR.tex}

\newpage
\input{LaTeX/Parts/P1a_ANorm_OracleCATE.tex}

\newpage
\input{LaTeX/Parts/P1a_ANorm_CATE.tex}

\newpage
\input{LaTeX/Parts/P2a_ClosedForms.tex}

\newpage
\input{Parts/P3_VarEst_NPR.tex}

\newpage
\input{Parts/P3_VarEst_CATE.tex}
...
\newpage
\input{LaTeX/Parts/P2c_ErrorDecomp.tex}
