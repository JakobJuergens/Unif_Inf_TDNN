...
\begin{proof}[Proof of Lemma \ref{lem_upsilon_sc}]
	\begin{equation}
		\begin{aligned}
			...
			+ \E_{D, D'}\left[\sum_{i = c+1}^{s_1}\sum_{j = c+1}^{s_2} \kappa(\mathbf{x}; \mathbf{Z}_i^{\prime}, D^{\prime})\kappa(\mathbf{x}; \mathbf{Z}_j, D)Y_i^{\prime} Y_j\right]
		\end{aligned}
	\end{equation}
	...
	\begin{equation}
		...
		\end{aligned}
	\end{equation}
	Considering the second term, we first split up one of the sums and deal with the resulting terms separately.
	\begin{equation}
		\begin{aligned}
			...
			%
			 & \quad = \E_{D, D'}\left[\left(\sum_{i = 1}^{c}\kappa(\mathbf{x}; \mathbf{Z}_i, D^{\prime}) Y_i\right)
				\left(\sum_{j = c+1}^{s_1} \kappa(\mathbf{x}; \mathbf{Z}_j, D) Y_j
				+ \sum_{j = s_1+1}^{s_2} \kappa(\mathbf{x}; \mathbf{Z}_j, D) Y_j\right)
			\right]                                                                                                                                                                           \\
			%
			 & \quad = \E_{D, D'}\left[\sum_{i = 1}^{c}\sum_{j = c+1}^{s_1}Y_i Y_j \kappa(\mathbf{x}; \mathbf{Z}_i, D^{\prime})\kappa(\mathbf{x}; \mathbf{Z}_j, D)\right]
			+ \E_{D, D'}\left[\sum_{i = 1}^{c}\sum_{j = s_1+1}^{s_2}Y_i Y_j \kappa(\mathbf{x}; \mathbf{Z}_i, D^{\prime})\kappa(\mathbf{x}; \mathbf{Z}_j, D)\right]                            \\
			%
			 & \quad = \E_{D, D'}\left[c(s_1 - c) \, Y_1 Y_{s_1} \kappa(\mathbf{x}; \mathbf{Z}_1, D^{\prime})\kappa(\mathbf{x}; \mathbf{Z}_{s_1}, D)\right]
			+ \E_{D, D'}\left[c (s_2 - s_1) Y_1 Y_{s_2} \kappa(\mathbf{x}; \mathbf{Z}_1, D^{\prime})\kappa(\mathbf{x}; \mathbf{Z}_{s_2}, D)\right]                                            \\
			%
			 & \quad = \frac{c (s_1 - c)}{s_1 s_2}\E_{D, D'}\left[Y_1 Y_{s_1} \, s_1 s_2 \,\kappa(\mathbf{x}; \mathbf{Z}_1, D^{\prime})\kappa(\mathbf{x}; \mathbf{Z}_{s_1}, D)\right]         \\
			 & \quad \quad + \frac{c (s_2 - s_1)}{s_1 s_2}\E_{D, D'}\left[ Y_1 Y_{s_2}\, s_1 s_2 \,\kappa(\mathbf{x}; \mathbf{Z}_1, D^{\prime})\kappa(\mathbf{x}; \mathbf{Z}_{s_2}, D)\right] \\
			%
			 & \quad \leq \frac{c (s_1 - c)}{s_1 s_2}
			\E_{D'}\left[|\mu(\mathbf{X}_1)| \, s_1  \,\kappa(\mathbf{x}; \mathbf{Z}_1, D^{\prime})\right]
			\E_{D'}\left[|\mu(\mathbf{X}_{s_1})| \, s_2  \,\kappa(\mathbf{x}; \mathbf{Z}_{s_1}, D)\right]                                                                                     \\
			 & \quad \quad + \frac{c (s_2 - s_1)}{s_1 s_2}\E_{D'}\left[|\mu(\mathbf{X}_1)| \, s_1  \,\kappa(\mathbf{x}; \mathbf{Z}_1, D^{\prime})\right]
			\E_{D'}\left[|\mu(\mathbf{X}_{s_2})| \, s_2  \,\kappa(\mathbf{x}; \mathbf{Z}_{s_2}, D)\right]
	...
	\begin{equation}
		...
		\end{aligned}
	\end{equation}
	Lastly, concerning the fourth term, we find the following.
	\begin{equation}
		\begin{aligned}
			 & \E_{D, D'}\left[\sum_{i = c+1}^{s_1}\sum_{j = c+1}^{s_2} \kappa(\mathbf{x}; \mathbf{Z}_i^{\prime}, D^{\prime})\kappa(\mathbf{x}; \mathbf{Z}_j, D)Y_i^{\prime} Y_j\right] \\
			%
